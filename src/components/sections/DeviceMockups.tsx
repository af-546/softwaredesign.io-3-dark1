...
export function PhoneMockup() {
  return (
    ...
    >
      ...
      <text x="66" y="282" fontSize="11" fontWeight="600" fontFamily="-apple-system, sans-serif" fill="#0F62FE">
        $24.00
      </text>
      ...
      <text x="66" y="370" fontSize="11" fontWeight="600" fontFamily="-apple-system, sans-serif" fill="#0F62FE">
        $22.00
      </text>
...
export function TabletMockup() {
  return (
    ...
    >
      ...
      <text x="290" y="29" fontSize="8" fontFamily="-apple-system, sans-serif" fontWeight="600" fill="#0F62FE" textAnchor="middle">
        AC
      </text>
      ...
      <rect x="16" y="56" width="52" height="18" rx="4" fill="#0F62FE" opacity="0.12" />
      <rect x="22" y="62" width="3" height="6" rx="1" fill="#0F62FE" />
      <text x="32" y="68" fontSize="8" fontWeight="500" fontFamily="-apple-system, sans-serif" fill="#0F62FE">
        Dashboard
      </text>
      ...
      <text x="248" y="90" fontSize="7" fontFamily="ui-monospace, monospace" fill="#0F62FE" letterSpacing="0.5">
        SUCCESS
      </text>
      <text x="248" y="108" fontSize="14" fontFamily="-apple-system, sans-serif" fontWeight="600" fill="#0F62FE">
        98%
      </text>
