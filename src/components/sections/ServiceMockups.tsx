 ...
 * Each is sized to fit a card content area and uses brand colors.
 */
...
export function WebDesignMock() {
  return (
    <svg viewBox="0 0 280 180" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <text x="22" y="158" fontSize="7" fontFamily="-apple-system, sans-serif" fill="#0F62FE">
        $18
      </text>
      ...
      <text x="107" y="158" fontSize="7" fontFamily="-apple-system, sans-serif" fill="#0F62FE">
        $22
      </text>
      ...
      <text x="192" y="158" fontSize="7" fontFamily="-apple-system, sans-serif" fill="#0F62FE">
        $21
      </text>
    </svg>
  );
...
export function SaasDesignMock() {
  return (
    <svg viewBox="0 0 280 180" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <rect x="12" y="18" width="42" height="14" rx="3" fill="#0F62FE" opacity="0.12" />
      <rect x="16" y="21" width="2" height="8" rx="1" fill="#0F62FE" />
      <text x="22" y="28" fontSize="7" fontWeight="500" fontFamily="-apple-system, sans-serif" fill="#0F62FE">
        Dashboard
      </text>
      ...
      <text x="212" y="50" fontSize="6" fontFamily="ui-monospace, monospace" fill="#0F62FE" letterSpacing="0.5">
        GROWTH
      </text>
      <text x="212" y="66" fontSize="11" fontWeight="600" fontFamily="-apple-system, sans-serif" fill="#0F62FE">
        +24%
      </text>
...
export function UIUXMock() {
  return (
    <svg viewBox="0 0 280 180" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <rect x="36" y="138" width="74" height="8" rx="4" fill="#0F62FE" opacity="0.3" />

      {/* Hi-fi frame */}
      <rect x="150" y="24" width="120" height="138" rx="6" fill="#FFFFFF" stroke="rgba(10,10,10,0.14)" />
      <text x="152" y="20" fontSize="7" fontFamily="ui-monospace, monospace" fill="#0F62FE" letterSpacing="0.5">
        HI-FI · 320×640
      </text>
      ...
      <defs>
        <linearGradient id="uiuxGrad" x1="0" y1="0" x2="1" y2="0">
          ...
          <stop offset="100%" stopColor="#0848C7" />
        </linearGradient>
      </defs>
      ...
      {/* Annotation line */}
      <path d="M 140 90 L 150 90" stroke="#0F62FE" strokeWidth="1" strokeDasharray="2,2" />
    </svg>
  );
}
...
export function ProductDesignMock() {
  return (
    <svg viewBox="0 0 280 180" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      {/* Phase columns */}
      <text x="20" y="60" fontSize="6" fontFamily="ui-monospace, monospace" fill="#0F62FE" letterSpacing="0.8">
        DISCOVERY
      </text>
      <rect x="20" y="66" width="74" height="22" rx="4" fill="#E6EEFF" />
      <text x="26" y="80" fontSize="7" fontFamily="-apple-system, sans-serif" fill="#0F62FE">
        User research
      </text>
      <rect x="20" y="92" width="74" height="22" rx="4" fill="#E6EEFF" />
      <text x="26" y="106" fontSize="7" fontFamily="-apple-system, sans-serif" fill="#0F62FE">
        Competitive audit
      </text>
      ...
      <rect x="20" y="156" width="92" height="6" rx="3" fill="#0F62FE" />
      <circle cx="112" cy="159" r="5" fill="#FFFFFF" stroke="#0F62FE" strokeWidth="2" />
    </svg>
  );
}
...
export function ErpAdminMock() {
  return (
    <svg viewBox="0 0 280 180" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <rect x="14" y="18" width="36" height="8" rx="4" fill="#0F62FE" fillOpacity="0.15" />
      ...
      <rect x="210" y="12" width="56" height="20" rx="10" fill="#0F62FE" />
      ...
      <text x="169" y="69" fontSize="6.5" fontFamily="-apple-system, sans-serif" fill="#0F62FE" textAnchor="middle">
        Proposal
      </text>
...
export function MobileMock() {
  return (
    <svg viewBox="0 0 280 180" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <rect x="216" y="58" width="50" height="22" rx="11" fill="#0F62FE" />
      ...
      <rect x="24" y="118" width="42" height="14" rx="2" fill="#0F62FE" opacity="0.1" />
      ...
      <circle cx="86" cy="130" r="5" fill="#0F62FE" opacity="0.2" />
